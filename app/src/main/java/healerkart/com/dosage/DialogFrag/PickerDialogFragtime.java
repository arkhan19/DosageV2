...
public class PickerDialogFragtime extends DialogFragment implements TimePickerDialog.OnTimeSetListener{
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        ...
        ((TextView) getActivity().findViewById(R.id.time_view)).setText(txt);
