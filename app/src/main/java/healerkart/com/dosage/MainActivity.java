...
public class MainActivity extends AppCompatActivity
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        switch (position) {
            case 0:
                getFragmentManager().beginTransaction().replace(R.id.container, new HomeFrag()).commit();
                break;
            case 1:
                getFragmentManager().beginTransaction().replace(R.id.container, new dosageFrag()).commit();
                break;
            default:
