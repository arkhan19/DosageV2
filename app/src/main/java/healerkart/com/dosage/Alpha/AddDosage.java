...
import healerkart.com.dosage.Delta.*;
import healerkart.com.dosage.MainActivity;
    ...
    protected Dialog onCreateDialog(final int id) {
        ...
        switch(id) {
            case DIALOG_ATTIME:
                ...
                return new TimePickerDialog(this, mTimeSetListener, cal.get(Calendar.HOUR_OF_DAY), cal.get(Calendar.MINUTE), DosageDB.is24Hours());
